      ...
      // 管理员管理页面
      {
        ...
        children: [
          ...
          // 修改体测标准
          {
            ...
            component: () => import('@/views/updateScoringStandard/updateScoringStandard.vue'),
          },
          // 修改教师信息
          {
            path: 'editteacher/:id',
          ...
          //   管理员修改学生分数
          {
            path: 'editstuscore/:id',
            component: () => import('@/views/manageEditView/manageEditView.vue'),
          },
          //   查看体测任务完成情况
          {
            path: 'viewtaskprogress/:id',
            component: () => import('@/views/viewTaskProgressView/viewTaskProgressView.vue'),
          },
        ],
      },
      // 教师管理页面
