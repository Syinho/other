<template>
    <div>
        ...
        >
            ...
            <el-table-column prop="fields.run800" label="800m">
                <template #default="scope">
                    <el-text>{{ handle_time(scope.row.fields.run800) }}</el-text>
                </template>
            </el-table-column>
            <el-table-column prop="fields.run1000" label="1000m">
                <template #default="scope">
                    <el-text>{{ handle_time(scope.row.fields.run1000) }}</el-text>
                </template>
            </el-table-column>
            <!-- 体测项目分数, 不可更改 -->
            <el-table-column prop="fields.bmi_score" label="BMI分数"></el-table-column>
            <el-table-column
                prop="fields.curlorup_score"
                label="引体向上/仰卧起坐得分"
            ></el-table-column>
